...
\begin{equation}
    p_0(x,y) = p_{0,y}(y) \cos(2\pi x)+P_0,\label{eqn:shear_flow_ansatz}
\end{equation}
...
\begin{equation}
    \begin{aligned}
        4\pi^2 p_{0,y} - p_{0,y}'' & = 4\pi^2 g(y)                                                                  \qquad\text{with $g(y) := \frac{1}{4\pi} \partial_y Q_{0,x}(y)$.}
...
\begin{equation}
    g(y)  = \begin{cases}
        (4\pi\rho)^{-1} \left(1-\tanh^2\left(\left(y-\frac{1}{4}\right)/\rho\right)\right) & \text{for $0\le y\le \frac{1}{2}$,} \\
        -(4\pi\rho)^{-1}\left(1-\tanh^2\left(\left(\frac{3}{4}-y\right)/\rho\right)\right) & \text{for $\frac{1}{2}<y \le 1$.}
    \end{cases}
\end{equation}
...
\begin{xalignat}{2}
    ...
    a_k &= \frac{1}{\pi}\int_{-\pi}^{+\pi} f(z) \sin((2k+1)z )\;dz\label{eqn:fourier_series_f}
\end{xalignat}
...
\begin{equation}
    p_0(x,y) = \cos(2\pi x) \sum_{k=0}^{\infty} a_k\frac{\sin\left(2\pi (2k+1)\left(y-\tfrac{1}{2}\right)\right)}{1+(2k+1)^2}\label{eqn:fourier_series_final}
\end{equation}
